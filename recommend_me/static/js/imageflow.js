...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		reflectionP:        0.8,            /* Height of the reflection in % of the source image */
		reflectionPNG:      false,          /* Toggle reflect2.php or reflect3.php */
		reflectionGET:      '',             /* Pass variables via the GET method to the reflect_.php script */
		imageFocusMax:      4,              /* Max number of images on each side of the focussed one */
		imageFocusM:        1.13295,            /* Multiplicator for the focussed image size in percent */
		...
		xStep:              170,            /* Step width on the x-axis in px */
		captions:           true,           /* Toggle captions */
		opacity:            true,          /* Toggle image opacity */
		opacityArray:       [10,9.5,9,10,10],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
	...
	this.refresh = function()
	{
		...
		this.maxHeight = Math.round(thisObject.iWidth * 0.25);
	...
	this.moveTo = function(x)
	{
		...
		for (var index = 0; index < thisObject.max; index++)
		{
			...
			else
			{
				...
				var newImageTop = (thisObject.iWidth * 0.15 - newImageH) + ((newImageH / (thisObject.reflectionP + 1)) * thisObject.reflectionP);
